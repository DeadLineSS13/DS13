...
#define ERT_EDF_MARINES	"edf_marines"
#define ERT_UNITOLOGY	"unitologists"
#define ERT_CEC_REPAIR	"cec_repair"


#define ROLETEXT_EARTHGOV_AGENT	"EarthGov Agent"


#define OBJECTIVE_SABOTAGE_TIME_REDUCTION	5 MINUTES